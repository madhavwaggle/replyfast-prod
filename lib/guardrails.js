...
const COMMITMENT_PATTERNS = [
  ...
  /\b(you're (confirmed|booked|scheduled) (for|on|at))\b/i,
  /\b(i('ve| have) (scheduled|booked|arranged|confirmed) (a |your )?(showing|tour|appointment|call|meeting))\b/i,
...
export function fallbackReply(agentName) {
  const fallbacks = [
    `Thanks for that — happy to help! What's your timeline for this?`,
    `Got it, thanks! Are you looking to move in the next few months or still exploring?`,
    `Thanks for the message! Do you have a price range in mind, or are you still figuring that out?`,
  ];
