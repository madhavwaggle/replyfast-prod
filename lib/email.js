...
<head>
  ...
  <title>Say HelloLeads</title>
</head>
<body style="margin:0;padding:0;background:#f0f0ec;font-family:'Helvetica Neue',Arial,sans-serif;">
${preheader ? `<!-- preheader --><div style="display:none;max-height:0;overflow:hidden;mso-hide:all;">${preheader}&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;</div>` : ''}
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:540px;">
        ...
        <tr><td style="background:#3d6b4a;border-radius:12px 12px 0 0;padding:24px 32px;">
          <div style="font-size:18px;font-weight:700;color:#ffffff;letter-spacing:-.3px;">Say HelloLeads</div>
          <div style="font-size:12px;color:rgba(255,255,255,.65);margin-top:3px;">Real estate AI · instant lead response</div>
        </td></tr>

        <!-- BODY -->
        <tr><td style="background:#ffffff;padding:32px;border-left:1px solid #e2e2dc;border-right:1px solid #e2e2dc;">
          ${body}
        </td></tr>
        ...
        <tr><td style="background:#f7f7f4;border:1px solid #e2e2dc;border-top:none;border-radius:0 0 12px 12px;padding:16px 32px;text-align:center;">
          <p style="font-size:12px;color:#999;margin:0;">
            Say HelloLeads &middot; <a href="${BASE_URL()}" style="color:#999;">sayhelloleads.com</a><br>
  ...
  const html = layout({
    ...
    body: `
      ...
      <div style="text-align:center;margin:28px 0;">
        <!--[if mso]>
        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${link}" style="height:50px;v-text-anchor:middle;width:260px;" arcsize="16%" strokecolor="#3d6b4a" fillcolor="#3d6b4a">
          <w:anchorlock/>
          <center style="color:#ffffff;font-family:Arial,sans-serif;font-size:15px;font-weight:bold;">Verify my email →</center>
        </v:roundrect>
        <![endif]-->
        <!--[if !mso]><!-->
        <a href="${link}" style="display:inline-block;background:#3d6b4a;color:#ffffff;font-size:15px;font-weight:600;padding:14px 36px;border-radius:8px;text-decoration:none;letter-spacing:-.1px;mso-hide:all;">
          Verify my email →
        </a>
        <!--<![endif]-->
      </div>
      ...
      <div style="background:#f7f7f4;border:1px solid #e2e2dc;border-radius:8px;padding:14px 16px;margin:24px 0 0;">
        <p style="font-size:13px;color:#666;margin:0 0 6px;font-weight:600;">Button not working? Use this link:</p>
        <a href="${link}" style="color:#3d6b4a;font-size:13px;word-break:break-all;display:block;">${link}</a>
      </div>
