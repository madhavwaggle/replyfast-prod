            ...
            <form onSubmit={handleSubmit}>
              ...
              {mode === 'password' && (
                <div style={{ marginBottom: '1.25rem' }}>
                  <label style={{ display: 'block', fontSize: '13px', fontWeight: '500', marginBottom: '.35rem' }}>Password</label>
                  <input
                    type="password"
                    value={password}
  ...
  return (
    <>
      ...
      <div style={{ width: '100%', maxWidth: '400px', padding: '1.5rem' }}>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '12px', color: 'var(--muted)' }}>
          Need help? See the <a href="/setup" style={{ color: 'var(--sage)' }}>setup guide</a>
        </p>
      </div>
    </>
  );
